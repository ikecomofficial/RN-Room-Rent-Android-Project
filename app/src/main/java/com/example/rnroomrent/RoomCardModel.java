...
public class RoomCardModel {
    ...
    private String custom_rent;
    private String tenant_profile_pic;
    ...
    public RoomCardModel(String room_id, String room_name, String custom_rent,
                         String tenant_profile_pic, String tenant_name,
                         String tenant_phone, String rent_status, String unit_paid_up_to) {
        this.room_id = room_id;
        this.room_name = room_name;
        this.custom_rent = custom_rent;
        this.tenant_profile_pic = tenant_profile_pic;
    ...
    public String getCustom_rent() {
        return custom_rent;
    }

    public void setCustom_rent(String custom_rent) {
        this.custom_rent = custom_rent;
    }

    public String getTenant_profile_pic() {
        return tenant_profile_pic;
    }

    public void setTenant_profile_pic(String tenant_profile_pic) {
        this.tenant_profile_pic = tenant_profile_pic;
    }
